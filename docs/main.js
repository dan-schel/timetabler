  ...
  var BlocksRenderer = class {
    ...
    onTimetableUpdate(timetable2) {
      timetable2.choices.forEach((c) => {
        ...
        const newCoordinates = timetableBlocks.map((b) => {
          ...
          const firstBlockEnd = startLocation.x == endLocation.x ? endLocation.y : this._gridlines.endHour - this._gridlines.startHour;
          let overflow = null;
    ...
    animatePrimaryBlocks(timetableClass, newCoordinates) {
